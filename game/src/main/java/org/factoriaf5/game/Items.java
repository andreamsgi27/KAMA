...
public class Items {
    ...
    public int Sword (int aidenDamage) {
        itemName = "Espada";
        int swordDamage = 10;
        int totalDamage  = swordDamage + aidenDamage;
        System.out.println("Aiden usa una espada con" + swordDamage + " de daño.");
        System.out.println("Aiden inflige ahora" + totalDamage + " de daño");
        return totalDamage;
    }
